...
> ⚠️ **중요 업데이트 (2025-12-10):** Look-ahead Bias 발견 및 수정 완료  
> 초기 백테스트 결과(CAGR 53.8%)는 **무효**입니다.  
> 수정 후 실제 성과: CAGR 14.6%, MDD -16.0%  
> 자세한 내용은 [CHANGELOG.md](CHANGELOG.md) 참조

래리 윌리엄스의 변동성 돌파 전략을 한국 주식 시장에 적용한 체계적 백테스트 프로젝트
